...
class MusiciansControllerTest < ActionController::TestCase
  ...
  test "should create musician" do
    assert_difference('Musician.count') do
      post :create, musician: { biography: @musician.biography, birthdate: @musician.birthdate, country: @musician.country, name: @musician.name }
    end
  ...
  test "should update musician" do
    patch :update, id: @musician, musician: { biography: @musician.biography, birthdate: @musician.birthdate, country: @musician.country, name: @musician.name }
    assert_redirected_to musician_path(assigns(:musician))
  end
